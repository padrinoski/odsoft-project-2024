...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.DELETE,"/api/books/{isbn}").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/public/login-form").permitAll()
                ...
                .oauth2Login(auth -> auth.loginPage("/oauth_login"))
