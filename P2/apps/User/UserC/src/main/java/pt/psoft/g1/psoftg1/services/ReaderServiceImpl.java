...
public class ReaderServiceImpl implements ReaderService {
    ...
    public ReaderDTO create(Reader reader) throws Exception  {
        ...
        final CreateReaderEvent eventMsg = new CreateReaderEvent(reader.getUsername(), reader.getPassword(), reader.getName(), reader.getAuthority(),reader.getBirthDate(), reader.getPhoneNumber(), reader.getInterestList());
    ...
    public ReaderDTO update(final String id, final Reader request) throws Exception {
        ...
        final CreateReaderEvent eventMsg = new CreateReaderEvent(request.getUsername(), request.getPassword(), request.getName(), request.getAuthority(),request.getBirthDate(), request.getPhoneNumber(), request.getInterestList());
