...
//
//@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = {BooksQueryApplication.class, BooksQueryApplication.class})
//@AutoConfigureStubRunner(ids = ["pt.psoft.g1.psoftg1:psoft-g1:0.0.1-SNAPSHOT:stubs"], stubsMode = LOCAL)
//@Testcontainers
//@ActiveProfiles("test")
